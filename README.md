...
**This problem has been specifically adapted for benchmarking derivative free optimization algorithms.** 
...
The source code of the two variants are in separate directories.
